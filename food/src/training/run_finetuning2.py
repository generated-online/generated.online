...
class DataTrainingArguments:
    ...
    line_by_line: bool = field(
        default=False,
        metadata={
            "help": "Whether distinct lines of text in the dataset are to be handled as "
            "distinct sequences."
        },
    )
    ...
    mlm: bool = field(
        default=False,
        metadata={
            "help": "Train with masked-language modeling loss instead of language "
            "modeling."
        },
    )
...
def main():  # noqa C901
    ...
    if data_args.eval_data_file is None and training_args.do_eval:
        raise ValueError(
            "Cannot do evaluation without an evaluation data file. Either supply a file "
            "to --eval_data_file "
    ...
    if (
        ...
        raise ValueError(
            ...
            f"empty. Use --overwrite_output_dir to overcome."
        )
    ...
    if (
        ...
        raise ValueError(
            "BERT and RoBERTa-like models do not have LM heads but masked LM heads. They"
            " must be run using the --mlm "
