<template>
    <div class="boldy">
        ...
        <v-container class="pb-6">
            <v-row no-gutters>
                <v-col ref="postcardCol" :style="'height: ' +postcardHeight+'px; overflow: hidden'" cols="12" lg="6"
                       md="6">
                    <!-- Postcards -->
                    <Postcard ref="postcard" :absender='absender' :country='country'
                              :horizontal="$vuetify.breakpoint.smOnly"
                              :name='name'
                              :parent-width="postcardWidth" :recipe='recipe' :street='street' :zip='zipCode()'
                ...
                <v-col :style="{
                    ...
                    <div class="center-button">
                        <v-btn v-if='!showMore && $vuetify.breakpoint.xsOnly' class="black-button"
                               @click="showMore=!showMore">Erfahre mehr
                        </v-btn>
                    </div>
                            ...
                            <div class="moneySpan mb-4">
                                ...
                                <div class="mx-1" style="width: min-content">
                                    <input v-model.number="money" :min='0' :step='0.5'
                                           class="moneyInput ma-0 boldy-color"
                                           type="number">
                                </div>
...
.countrySelect, .moneyInput, .nameInput,
.address input {
  padding-left: 1em;
  padding-top: 0.3em;
